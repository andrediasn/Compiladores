   ...
   public static void main(String[] args){
       if( args.length < 1 ){
          ...
          System.out.println(" -bsm : Executa uma bateria de testes no interpretador");   
					System.out.println(" -bjc : Executa uma bateria de testes no gerador de cógido em Java");          
	   ...
	   ParseAdaptor langParser = new Main();
          ...
          if(args[0].equals("-bs") ){
              ...
              return;
          } if(args[0].equals("-bjc") ){
              System.out.println("Executando bateria de testes no gerador de cógido em Java:");
              TestVisitorCompiler in = new TestVisitorCompiler(langParser); 
              return;
          }
          if(args.length != 2){
