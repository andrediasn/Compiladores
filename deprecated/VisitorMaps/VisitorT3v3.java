...
public abstract class Visitor
{
    ...
    public abstract void visit(CModule module/*ModuleT module*/);
    public abstract void visit(Mult mult);
    public abstract void visit(SMinus neg/*Neg neg*/);
    ...
    public abstract void visit(SlcArray selector);
    public abstract void visit(SlcData selector);
	public abstract void visit(True tr);
    public abstract void visit(Type type);
    public abstract void visit(Bool typeBool/*TypeBool type*/);
	public abstract void visit(Char typeChar/*TypeChar type*/);
    public abstract void visit(TFloat typeFloat/*TypeFloat type*/);
    public abstract void visit(IDType idType /*TypeIDType type*/);
	public abstract void visit(Int typeInt/*TypeInt type*/);
}
