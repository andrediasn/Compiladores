...
public abstract class Visitor
{
    public abstract void visit(Program p); 
		public abstract void visit(Data e); // para armazenar informações do tipo data definido
    public abstract void visit(AccessData e);  //SelectorData - para demonstrar o acesso a um elemento de data com determinado identificador
  	public abstract void visit(Decl e); // para armazenar informações dos tipo de data
    public abstract void visit(StmtList e); // CmdArray - Lista de comandos
    public abstract void visit(CallCmd e); // para chamadas de função como comando
    ...
    public abstract void visit(LValue e); //para armazenar ID e seus seletores
    ...
    public abstract void visit(Array e); //SelectorArray - acesso a posição da array
