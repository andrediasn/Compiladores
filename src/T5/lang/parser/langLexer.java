...
public class langLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"NULL", "IF", "ELSE", "ITERATE", "READ", "PRINT", "RETURN", "NEW", "LEFTPARENT", 
			"RIGHTPARENT", "LEFTBRACE", "RIGHTBRACE", "LEFTBRACKET", "RIGHTBRACKET", 
			"GT", "LT", "DOT", "COMMA", "COLON", "SEMICOLON", "DOUBLECOLON", "ATTR", 
			"EQ", "NEQ", "ADD", "SUB", "MULT", "DIV", "MOD", "AND", "NOT", "ID", 
			"IDTYPE", "INT", "FLOAT", "CHAR", "ENDLINE", "EMPTY", "LINECOMMENT", 
			"MULTLINESCOMMENT"
		};
	}
