...
public class langLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"DATA", "TYPEINT", "TYPEFLOAT", "TYPECHAR", "TYPEBOOL", "TRUE", "FALSE", 
			"NULL", "LEFTPARENT", "RIGHTPARENT", "LEFTBRACE", "RIGHTBRACE", "LEFTBRACKET", 
			"RIGHTBRACKET", "GREATER", "LESS", "DOT", "COMMA", "COLON", "SEMICOLON", 
			"DOUBLECOLON", "ATTR", "EQ", "NEQ", "PLUS", "MINUS", "MULT", "DIV", "MOD", 
			"AND", "NOT", "IF", "ELSE", "ITERATE", "READ", "PRINT", "RETURN", "NEW", 
			"INT", "FLOAT", "CARACTER", "ENDLINE", "EMPTY", "LINECOMMENT", "MULTLINESCOMMENT", 
			"ID", "IDTYPE"
		};
	}
